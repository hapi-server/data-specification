...
| `description`       | string             | **Optional** A brief description of the dataset. The short, human-readable `title` of the dataset is given in the catalog response while the description can be longer (a few lines, i.e., 1000 characters max).       |
