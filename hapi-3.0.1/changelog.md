<!--- TOC --->
 ...
 [1 Changes from 2.1.1 to 3.0.0](#1-changes-from211-to300)<br/>
&nbsp;&nbsp;&nbsp; [1.1 v2 to v3 API Changes](#11-v2-to-v3-api-changes)<br/>
&nbsp;&nbsp;&nbsp; [1.2 v2 to v3 Schema Changes](#12-v2-to-v3-schema-changes)<br/>
 [2 Changes from 2.1.0 to 2.1.1](#2-changes-from210-to211)<br/>
 [3 Changes from 2.1.0 to 3.0.0](#3-changes-from210-to300)<br/>
 [4 Changes from 3.0.0 to 3.0.1](#4-changes-from-300-to-301)<br/>

<!--- /TOC --->
# 1 Changes from 2.1.1 to 3.0.0
